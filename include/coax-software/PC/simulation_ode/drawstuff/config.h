...
#define PACKAGE_STRING "ODE 0.10.1"
...
/* Use an alternative trimesh-trimesh collider which should yield better
   results */
/* #undef dTRIMESH_OPCODE_USE_NEW_TRIMESH_TRIMESH_COLLIDER */
