...
class CoaxRequestStateResponse(roslib.message.Message):
  _md5sum = "47baeb0c323ae11ef07fe0238ef0ef61"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2B2f.pack(_x.state.coaxspeed.state, _x.state.coaxspeed.light, _x.state.coaxspeed.vel_x, _x.state.coaxspeed.vel_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.coaxspeed.state, _x.state.coaxspeed.light, _x.state.coaxspeed.vel_x, _x.state.coaxspeed.vel_y,) = _struct_2B2f.unpack(str[start:end])
      start = end
      end += 12
...
class CoaxRequestState(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'ae3aa297ac68a7d1fadd8c4a7d35ebb3'
